  ...
  useEffect(() => {
    ...
    const changeDecryption = () => {
      ...
      if (svgTime <= 28300 && svgTime >= 28100) {
        setTimeout(_changeIt, 80);
        setDecryptionTimeout(setTimeout(changeDecryption, 68200 - svgTime));
      } else {
        console.debug("svgAnimDecryption out of sync:", svgTime);
        if (svgTime < 28100) {
          setDecryptionTimeout(setTimeout(changeDecryption, 28200 - svgTime));
        } else {
          setDecryptionTimeout(setTimeout(changeDecryption, 68200 - svgTime));
        }
      }
    ...
    <div className="absolute bottom-4 left-0 right-0 top-4 flex items-center justify-center max-sm:-top-8 max-sm:bottom-8 sm:justify-end">
      ...
      >
        ...
        <g transform="translate(-30.7 -61.62)">
          ...
          >
            <tspan fill="hsl(var(--foreground))">storage</tspan>
          </text>
          <path
          ...
          <text
            ...
            transform="matrix(.866 .5 -1 .5774 0 0)"
          >
            <tspan fill="hsl(var(--foreground))">{encryption}</tspan>
          </text>
          <path
          ...
          <text
            ...
            transform="skewY(30)"
          >
            <tspan fill="hsl(var(--foreground))">{decryption}</tspan>
          </text>
          <path
            id="dataContainer"
          ...
          <text id="dataText" x={263.187} y={291.388} transform="skewY(-30)">
            <tspan fill="hsl(var(--foreground))">data</tspan>
          </text>
        </g>
      </svg>
    </div>
