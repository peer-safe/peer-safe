const BaseSection = ({
  ...
  return (
    <div
      className="relative flex flex-1 gap-8 rounded-2xl border-zinc-700 bg-[#101010] p-16 before:absolute before:-bottom-[1px] before:-left-[1px] before:-right-[1px] before:-top-[1px] before:-z-10 before:rounded-2xl before:bg-gradient-to-bl before:from-zinc-600 before:via-zinc-800 before:to-zinc-600 before:content-[''] max-lg:justify-between max-sm:flex-col"
      ref={ref}
    >
      {children}
    </div>
